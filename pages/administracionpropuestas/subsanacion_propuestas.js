                        ...
                        } else
                        {
                            ...
                            } else
                            {
                                ...
                                } else
                                {
                                    if (data == 'error_envio')
                                    {                                    
                                        notify("danger", "ok", "Subsanación:", "En algunas propuesta reporta error de envió de notificación, comuníquese con la mesa de ayuda soporte.convocatorias@scrd.gov.co");
                                    } else
                                    {
                                        if (data == 'ingresar')
                                        {
