$(document).ready(function () {
    ...
    } else
    {
        ...
        if (Number.isInteger(parseInt(getURLParameter('m'))))
        {
            ...
            $.ajax({
                type: 'GET',
                data: {"token": token_actual.token, "idp": $("#propuesta").attr('value'), "modulo": "Ajustes Junta y Agrupación"},
...
function cargar_tabla(token_actual)
{
    $('#table_registros').DataTable({
        ...
        "ajax": {
            ...
            data: {"token": token_actual.token, "participante": $("#participante").attr('value'), "propuesta": $("#propuesta").attr('value'), "modulo": "Ajustes Junta y Agrupación", "tipo": $("#tipo").attr('value')}
        },
