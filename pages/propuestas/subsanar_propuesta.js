            ...
            modalConfirm(function (confirm) {
                if (confirm) {
                    ...
                    $.ajax({
                        ...
                        {
                            notify("danger", "ok", "Propuesta:", "Su propuesta no esta en estado Subsanación Recibida, comuníquese con la mesa de ayuda soporte.convocatorias@scrd.gov.co");
                        } else
                        {
                            if (result == 'error')
                            {
