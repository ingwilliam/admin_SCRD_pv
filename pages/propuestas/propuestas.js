$(document).ready(function () {
    ...
    {
        href_regresar="perfil_agrupacion.html?m="+getURLParameter('m')+"&id="+getURLParameter('id')+"";
        href_siguiente="integrantes.html?m="+getURLParameter('m')+"&id="+getURLParameter('id')+"";
    }
    
    if(getURLParameter('m')=="pn")
    {
        href_regresar="perfil_persona_natural.html?m="+getURLParameter('m')+"&id="+getURLParameter('id')+"";
        href_siguiente="documentacion.html?m="+getURLParameter('m')+"&id="+getURLParameter('id')+"";
    }
    
    if(getURLParameter('m')=="pj")
    {
        href_regresar="perfil_persona_juridica.html?m="+getURLParameter('m')+"&id="+getURLParameter('id')+"";
        href_siguiente="junta.html?m="+getURLParameter('m')+"&id="+getURLParameter('id')+"";
    }
